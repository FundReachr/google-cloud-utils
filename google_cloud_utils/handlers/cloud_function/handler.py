...
if __name__ == "__main__":
    ...
    service_account_file = json.load(open(f'./src/var/login_credentials/{project_id}/admin_service_account.json'))
    CFH = CloudFunctionHandler(service_account_file)

    print(CFH.callCloudFunction(location = 'northamerica-northeast1', function_name = 'etl-klaviyo_v2'))