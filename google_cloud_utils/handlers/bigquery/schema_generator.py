...
class SchemaGenerator:
    ...
    def generateSchema(self,data,base_schema=None,force_type : str = None):
        ...
        def transformJsonToBigquerySchema(json_schema):
            ...
            return [
                processJsonField(field_name.replace('-','_') , json_schema["properties"][field_name]) for field_name in json_schema["properties"]] if "properties" in json_schema else []
